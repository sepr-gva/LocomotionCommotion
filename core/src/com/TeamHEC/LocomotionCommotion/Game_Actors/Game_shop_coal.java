...
public class Game_shop_coal {
	...
	public Game_shop_coal(){
		...
		CoalItem coalitem = new CoalItem();
	...
	public class CoalItem extends Actor{
		Texture texture = Game_TextureManager.getInstance().game_shop_coalitem; // reuse the new game back btn texture
		...
		public CoalItem(){
			...
			addListener(new InputListener(){
				public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
					((CoalItem)event.getTarget()).started = true;
					return true;
				}
			});
	...
	public static class BuyButton extends Actor{
		private static Texture texture = Game_TextureManager.getInstance().game_shop_buybtn; // reuse the new game back btn texture
