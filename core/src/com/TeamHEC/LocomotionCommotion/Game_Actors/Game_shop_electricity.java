...
public class Game_shop_electricity {
	...
	public Game_shop_electricity(){
		...
		ElectricityItem coalitem = new ElectricityItem();
	...
	public class ElectricityItem extends Actor{
		Texture texture = Game_TextureManager.getInstance().game_shop_electricityitem; // reuse the new game back btn texture
		...
		public ElectricityItem(){
			...
			addListener(new InputListener(){
				public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
					((ElectricityItem)event.getTarget()).started = true;
					return true;
				}
			});
