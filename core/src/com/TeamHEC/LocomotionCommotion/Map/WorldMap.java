...
public class WorldMap implements Serializable{
	...
	public final Station BERN = new Station("Bern", 950, new Nuclear(500), 100, new Line[]{Line.Purple, Line.Orange, Line.Orange}, 50, 731f, 300f);
	...
	public final Station HELSINKI = new Station("Helsinki", 900, new Oil(500), 100, new Line[]{Line.Brown, Line.Blue, Line.Blue}, 50, 1121f, 820f);
	...
	public final Station PRAGUE = new Station("Prague", 1000, new Oil(500), 100, new Line[]{Line.Orange, Line.Yellow, Line.Brown}, 50, 861f, 430f);
	public final Station REYKJAVIK = new Station("Reykjavik", 850, new Electric(500), 100, new Line[]{Line.Blue, Line.Black, Line.Black}, 50, 211f, 820f);
	public final Station ROME = new Station("Rome", 900, new Coal(500), 100, new Line[]{Line.Purple, Line.Green, Line.Green}, 50, 861f, 170f);
	public final Station STOCKHOLM = new Station("Stockholm", 900, new Oil(500), 100, new Line[]{Line.Blue, Line.Orange, Line.Orange}, 50, 861f, 820f);
	public final Station VIENNA = new Station("Vienna", 850, new Oil(500), 100, new Line[]{Line.Brown, Line.Brown, Line.Brown}, 50, 991f, 300f);
