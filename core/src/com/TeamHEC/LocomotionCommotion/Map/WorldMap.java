...
public class WorldMap implements Serializable{
	...
	private final Station AMSTERDAM = new Station("Amsterdam", 850, new Electric(500), 10, new Line[]{Line.Orange, Line.Orange, Line.Orange}, 10, 615f, 560f);
	private final Station ATHENS = new Station("Athens", 850, new Coal(500), 10, new Line[]{Line.Brown, Line.Green, Line.Green}, 10,  1121f, 170f);
	private final Station BERLIN = new Station("Berlin", 950, new Nuclear(500), 10, new Line[]{Line.Purple, Line.Red, Line.Red}, 10, 731f, 560f);
	private final Station BERN = new Station("Bern", 950, new Nuclear(500), 10, new Line[]{Line.Purple, Line.Orange, Line.Orange}, 10, 731f, 300f);
	private final Station DUBLIN = new Station("Dublin", 900, new Coal(500), 10, new Line[]{Line.Orange, Line.Black, Line.Black}, 10, 471f, 560f);
	private final Station HELSINKI = new Station("Helsinki", 900, new Oil(500), 10, new Line[]{Line.Brown, Line.Blue, Line.Blue}, 10, 1121f, 820f);
	...
	private final Station PRAGUE = new Station("Prague", 1000, new Oil(500), 10, new Line[]{Line.Orange, Line.Yellow, Line.Brown}, 10, 861f, 430f);
	private final Station REYKJAVIK = new Station("Reykjavik", 850, new Electric(500), 10, new Line[]{Line.Blue, Line.Black, Line.Black}, 10, 211f, 820f);
	private final Station ROME = new Station("Rome", 900, new Coal(500), 10, new Line[]{Line.Purple, Line.Green, Line.Green}, 10, 861f, 170f);
	private final Station STOCKHOLM = new Station("Stockholm", 900, new Oil(500), 10, new Line[]{Line.Blue, Line.Orange, Line.Orange}, 10, 861f, 820f);
	private final Station VIENNA = new Station("Vienna", 850, new Oil(500), 10, new Line[]{Line.Brown, Line.Brown, Line.Brown}, 10, 991f, 300f);
	private final Station VILNIUS = new Station("Vilnuis", 850, new Oil(500), 10, new Line[]{Line.Brown, Line.Brown, Line.Brown}, 10, 1121f, 690f);
	private final Station WARSAW = new Station("Warsaw", 950, new Coal(500), 10, new Line[]{Line.Red, Line.Orange, Line.Orange}, 10, 861f, 560f);
