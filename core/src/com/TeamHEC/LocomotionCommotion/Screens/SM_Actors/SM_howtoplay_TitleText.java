 ...
 * 
 * This is an Actor FOR THE TITLE FOR THE HOW TO PLAY PAGE- meaning it's given texture is displayed on the stage and actions (acts) can be performed.
 ...
 * 				Action- None
 */
public class SM_howtoplay_TitleText extends Actor {

	Texture texture = SM_TextureManager.sm_howtoplay_title;
	...
	public SM_howtoplay_TitleText(){
		...
		addListener(new InputListener(){
			public boolean touchDown (InputEvent event, float x, float y, int pointer, int button) {
				((SM_howtoplay_TitleText)event.getTarget()).started = true;
				return true;
			}
		});
	}
