package com.TeamHEC.LocomotionCommotion.camera;
...
public class OrthoCamera extends OrthographicCamera {
	...
	public OrthoCamera() {
		this(new VirtualViewport(LocomotionCommotion.WIDTH, LocomotionCommotion.HEIGHT));
	}
	...
	public void resize() {
		VirtualViewport virtualViewport = new VirtualViewport(LocomotionCommotion.WIDTH, LocomotionCommotion.HEIGHT);  
